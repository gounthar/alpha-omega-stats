...
SPREADSHEET_ID_OR_NAME="${SPREADSHEET_ID_OR_NAME:-"Jenkins PR Tracker"}" # or use the Sheet ID
WORKSHEET_NAME="${WORKSHEET_NAME:-"Sheet1"}" # Change to your worksheet name
